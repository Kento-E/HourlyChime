...
class ControlReceiver : BroadcastReceiver() {
    ...
    private fun handleSetEnabledDays(intent: Intent, current: TimeSignalSettings): TimeSignalSettings {
    ...
    private fun handleSetBluetoothFilter(intent: Intent, current: TimeSignalSettings): TimeSignalSettings {
        ...
        val addresses = if (addressesRaw.isNullOrBlank()) {
    ...
    private fun handleSetSkipHolidays(intent: Intent, current: TimeSignalSettings): TimeSignalSettings {
