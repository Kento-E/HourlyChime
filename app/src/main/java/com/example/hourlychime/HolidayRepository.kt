 ...
 * （内閣府が公表する祝日をもとにしたコミュニティAPIミラー）
 *
 * 取得データは SharedPreferences にキャッシュし、7日間有効とする。
 * ネットワーク通信は refreshSync() でのみ行い、isHoliday() はキャッシュのみ参照する。
 */
object HolidayRepository {
    ...
    private const val CACHE_TTL_MS = 7L * 24 * 60 * 60 * 1000 // 7日
